(function parentToNull(thisObj) {
    ...
    function makeNull (lyr) {
        ...
        var transA = ["ADBE Position","ADBE Scale","ADBE Rotate Z"];
        var staticVals = [];
        ...
        for (var t = 0; t<transA.length; t++) {
            ...
            staticVals.push(inTrans(transA[t]).value);
        }
    ...
    function buildUI(thisObj) {
        try{
        var pal = (thisObj instanceof Panel) ? thisObj : new Window("palette", "Null Maker", [200, 200, 600, 500], {resizeable: true});
